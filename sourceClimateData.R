    ...
    if (model == "CCSM4") {
     ...
     if (scenario == "RCP4.5") {
      ...
      if (scenario == 'RCP4.5') {
        ...
        ATAstack <- prepInputs(url = "https://drive.google.com/file/d/11kuhp-CZ4kTYhm4a0sSSPHPZPejW87Vk/view?usp=sharing",
                               targetFile = 'wholeRIA_20kmbuffer_CSIRO_mk3_ATA2011-2100.grd',
                               alsoExtract = 'wholeRIA_20kmbuffer_CSIRO_mk3_ATA2011-2100.gri',
                               destinationPath = path,
                               filename2 = 'wholeRIA_1ArcMin_CSIRO_Mk3_RC85_ATA2011-2100.grd',
                               fun = 'raster::stack')
        CMIstack <- prepInputs(url = 'https://drive.google.com/file/d/11kuhp-CZ4kTYhm4a0sSSPHPZPejW87Vk/view?usp=sharing',
                               targetFile = 'wholeRIA_20kmbuffer_CSIRO_mk3_CMI2011-2100.grd',
                               alsoExtract = 'wholeRIA_20kmbuffer_CSIRO_mk3_CMI2011-2100.gri',
                               destinationPath = path,
                               filename2 = 'wholeRIA_1ArcMin_CSIRO_Mk3_RC85_CMI2011-2100.grd',
                               fun = 'raster::stack')
      }
