dynamicPaths$outputPath <- "outputs/sims/BC/CSIRO-Mk3/RCP8.5/AMtest1_CSIROMk3_RCP85"
...
fSsimDataPrep <- loadSimList("C:/users/ieddy/downloads/fSsimDataPrep_BC.qs")
thlb <- raster("C:/users/ieddy/Downloads/BC_RIA_Greg_thlb.tif")
thlb <- projectRaster(from = thlb, to = simOutPreamble$rasterToMatch, method = "ngb")
